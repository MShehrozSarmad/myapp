...
import Silverscreen from './src/screens/Silverscreen';
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({size, color}) => (
            <Feather name="home" size={30} color="purple" />
          ),
        }}
      />
      <Tab.Screen name="Profile" component={Profile} />
      <Tab.Screen name="Screen" component={Silverscreen} />
    </Tab.Navigator>
  );
}
...
const StackNavigator = () => {
  return (
    <Stack.Navigator
      ...
      screenOptions={{
        headerStyle: {backgroundColor: 'red'}, //will apply to all screens
      }}>
      <Stack.Screen
        name="Home"
        component={Home}
      ...
      <Stack.Screen
        name="Profile"
        component={Profile}
        options={{title: 'My Profile', headerStyle: {backgroundColor: 'teal'}}}
      />
      <Stack.Screen name="Silver" component={Silverscreen} />
    </Stack.Navigator>
  );
};
